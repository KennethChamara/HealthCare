...
public class Appointment {
	...
	public String insertAppointment(AppointmentBean appointment) {
		...
		try {
			...
			output += GetInsertServiceFromPayment(appointment);
			con.close();
	...
	public String updateAppointment(AppointmentBean appointment) {
		...
		try {
			...
			output = "Updated successfully Appointment.";
			output += GetUpdatetServiceFromPayment(appointment);
		} catch (Exception e) {
	...
	public String deleteAppointement(AppointmentBean appointment) {
		...
		try {
			...
			output += GetDeleteServiceFromPayment(appointment);
			...
			preparedStmt.executeUpdate();
			con.close();
			output += " Deleting successfully Appointment";
		} catch (Exception e) {
